  ...
  return (
    <div className="py-10 px-44">
      ...
      <div className="grid grid-cols-4">
        <div className="p-4">
          <p className="text-lg font-bold">ECHO</p>
        ...
        <div className="p-4">
          ...
          <input
            type="email"
            placeholder="Email"
            className="border-2 border-black p-1 my-2"
          />
          <button className="bg-black text-white py-1 px-3 my-2">
            Subscribe
          </button>
        </div>
      </div>
      <div className="flex justify-center text-[#737373]">
        <p className="text-sm">© 2021 ECHO. All Rights Reserved</p>
      </div>
    </div>
  );
}
